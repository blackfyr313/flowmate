"""Minimize a window matching a process name or title."""
import asyncio
import ctypes
...
async def run(config: dict) -> None:
    ...
    await loop.run_in_executor(None, _minimize, process_name, window_title)


def _minimize(process_name: str, window_title: str) -> None:
